...
- Date: 2026-07-02T08:58:40-04:00
- Host: inspiron
...
# Subtest: installExecution
    # Subtest: createInitialExecutionState
        ...
        ok 1 - creates idle state
          ---
          duration_ms: 1.635165
          type: 'test'
          ...
        1..1
    ok 1 - createInitialExecutionState
      ---
      duration_ms: 4.848072
      type: 'suite'
      ...
    ...
    # Subtest: applyExecutionStatus
        ...
        ok 1 - transitions state correctly
          ---
          duration_ms: 0.908828
          type: 'test'
          ...
        1..1
    ok 3 - applyExecutionStatus
      ---
      duration_ms: 1.192595
      type: 'suite'
      ...
...
Antigravity MCP integration test: all 5 tools validated successfully. smoke=PASS, installer-critical=PASS (112/112), nix-full=BLOCKED.
