...
| hosts/iso/ | `hosts/iso/*` | `ISO_ONLY` | ❌ | kryonix-installer | ISO build | Médio | Usa installer modules |
...
| packages/kryonix-disk-planner | `packages/kryonix-disk-planner*` | `INSTALLER_PRODUCT` | ❌ | kryonix-installer | Exclusivo do installer | Médio | Só referenciado em installer/ISO |
...
| modules/nixos/installer/ | `modules/nixos/installer/*` | `INSTALLER_PRODUCT` | ❌ | kryonix-installer | TUI, kiosk, backend | Alto | ISO depende |
