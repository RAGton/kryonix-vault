...
- Date: 2026-07-01T17:57:38-04:00
- Host: inspiron
...
# Subtest: installExecution
    # Subtest: createInitialExecutionState
        ...
        ok 1 - creates idle state
          ---
          duration_ms: 1.543481
          type: 'test'
          ...
        1..1
    ok 1 - createInitialExecutionState
      ---
      duration_ms: 4.339816
      type: 'suite'
      ...
    ...
    # Subtest: applyExecutionStatus
        ...
        ok 1 - transitions state correctly
          ---
          duration_ms: 1.178946
          type: 'test'
          ...
        1..1
    ok 3 - applyExecutionStatus
      ---
      duration_ms: 1.476125
      type: 'suite'
      ...
    ...
    ok 4 - buildInstallStageList
      ---
      duration_ms: 2.269235
      type: 'suite'
      ...
    1..4
ok 79 - installExecution
  ---
  duration_ms: 11.956636
  type: 'suite'
  ...
# Subtest: installPlan
