...
> **Atualização 2026-06-15**: o installer foi reorganizado para repo próprio
> em <https://github.com/RAGton/kryonix-installer> (PR #1 aberto e MERGEABLE).
> Roadmap atual em [[Externalize-Roadmap]] · entrada principal em
> [[MOC - Installer]].

## Repositório

- GitHub: <https://github.com/RAGton/kryonix-installer> (novo, privado)
  - Antigo: `RAGEnterprise/kryonix-installer` (legado, não usar)
- Branch padrão: `main`
- Relação: instalador oficial do ecossistema KRYONIX, consumido pelo motor
  Kryonix como flake input direto
